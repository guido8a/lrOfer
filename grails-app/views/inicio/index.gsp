...
<body>
<div class="dialog">
    <div style="text-align: center;"><h1 class="titl" style="font-size: 20px;">SISTEMA DE OBRAS<br>
        GOBIERNO AUTÓNOMO DESCENTRALIZADO PROVINCIA DE LOS RÍOS</h1>
        <h1 class="titl" style="font-size: 24px; color: #6a5830">Registro de Ofertas</h1></div>
        <h3 style="font-size: 16px; color: #6a5830; text-align: center">Incluye Módulo VAE</h3>
