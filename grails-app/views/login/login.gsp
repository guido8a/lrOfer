...
<div class="alert hide" id="divError" role="status">
    ...
    <div style="text-align: center;"><h1 class="titl" style="font-size: 26px;">SISTEMA DE OBRAS - OFERENTES</h1>
        <h1 class="titl" style="font-size: 20px;">SEGUIMIENTO Y EJECUCIÓN DE OBRAS<br>
            GOBIERNO AUTÓNOMO DESCENTRALIZADO PROVINCIA DE LOS RÍOS</h1>
<div class="dialog ui-corner-all" style="height: 595px;padding: 10px;width: 910px;margin: auto;margin-top: -15px">
    ...
    <div style="text-align: center ; color:#004060; margin-top:120px; font-size: 10px;"><a href="http://www.tedein.com.ec" style="text-decoration: none; color: inherit">Desarrollado por: TEDEIN S.A. Versión ${message(code: 'version', default: '1.1.0x')}</a></div>
...
<div class="modal login hide fade " id="modal-ingreso" style=";overflow: hidden;">
    <div class="modal-body" id="modalBody" style="padding: 0px">
        ...
        <g:form class="well form-horizontal span login2" action="validar" name="frmLogin" style="width: 300px;position: relative;padding-left: 60px;margin: 0px">
            <p class="css-vertical-text tituloGrande" style="left: 12px;;font-family: 'Tulpen One',cursive;font-weight: bold;font-size: 35px; color: #334">Obras-Oferentes</p>
